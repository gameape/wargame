...
## ZOC
- 進入停止、戦闘結果以外退出不可
- （オプション）移動力が8以上のユニットは+4MPでEZOCを退出可、退出時にEZOC、敵軍マップ端、川を越えるヘクスには進入不可
...
- （オプション）攻撃側に同じ師団に所属する複数のユニットがいれば右に1コラムシフト
...
## （オプションシナリオ）ロレーヌのスクリーミング・イーグルズ
- 合衆国プレイヤーは好きなターンに第502空挺連隊を平地ヘクスに配置できる（自軍移動フェイズに、だと思う）
