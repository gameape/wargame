...
## SYR
- 自発SYRは次のいずれか
  - 通常の移動のかわりにスタックのSUP/PARを除く全ユニットが参加
  - ファイナルOWFのかわりにスタックのSUP/PARを除く全ユニットが参加
  - ポイントファイアベーストOWトリガーへの反応として任意の非Firedの車両が参加
- 強制SYRはモラルチェックでのみ発生、スタックの全ユニットが参加
- SYR手順
