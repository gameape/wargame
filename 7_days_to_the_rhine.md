...
- 移動力は偵察が9、Static Garrisonが0、それ以外は6
...
## 移動
- 最低移動なし
- NATOは渡河+1MP（TECにもマップの凡例にも書かれていない）、避難民ヘクス+1MP
...
- 砲兵支援は移動戦闘順なら1個、戦闘移動順なら3個、Pactが都市を攻撃するときは6個使用可
- ヘリコプターは航空機レンジ内で使用不可
...
- 敵ユニット存在ヘクスに配置（最大2個/ヘクス）、またはEWマーカー1個で敵航空マーカー1個を除去
