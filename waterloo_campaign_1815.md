...
- バトルスターの数
  ...
  - 防御するユニット、防御するユニットがレンジ内の戦闘モードHQ
...
### 退却
- 勝者から3ヘクス離れる
- 軍団存在ヘクス/敵デタッチメント存在ヘクス/EZOC/HQレンジ外/勝者から遠ざからないヘクスに進入ならブロウン

## Grand Battery
- 戦闘モードのナポレオンHQがレンジ内の友軍ユニットに配置可（EZOC/EZOI可）
- 移動不可、回収可
- スタックしているユニットが戦闘後前進して単独になったら回収
- スタックしているユニットが戦闘結果をこうむったら除去
- デタッチメント配置として数える

## Old Guard
- 戦闘モードのナポレオンHQがレンジ内の非EZOCのカラヘクスに配置可
- 移動不可、回収可
- デタッチメント配置として数える
- 軍団とスタックしているときはバトルスター使用不可
