...
- 偵察にユニットは使わない。偵察レーティングは常に6でOCAで修整。修整後の値がAir Intercept未満ならミッション成功
- ミッション失敗するまで偵察を繰り返す

### 航空計画フェイズ
- プライマリミッションに最大3ユニット、1レイドに最大5ユニット
- ひとつのボックスまたはトラックに最大3レイド/ターン
- 第2ターンからOEWミッション可、航空値が1以上の最大2ユニットをアサイン可、必ず成功、OCAマーカーを一時的に1個右に
...
### 航空阻止セグメント
- 航空護衛ミッション参加ユニットの航空値合計 vs 解決カードのAir Intercept値 - OCA修整
...
### 地上防御セグメント
- SEADミッション参加ユニットの地上攻撃値合計 vs 解決カードのGround Defense値 - DEAD修整
