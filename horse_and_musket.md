...
- 縦隊
  - 縦隊ユニットへの射撃は+1DRM
  - 縦隊の馬が他の馬のいるヘクスを射撃するなら戦闘ダイスに+1DRM
  - 縦隊ユニットは近接戦闘のモラルチェックで-1DRM
  - 縦隊の歩兵は近接戦闘の戦闘ダイスに+1DRM
  - 縦隊の馬はチャージの戦闘のダイスに+1DRM、カウンターチャージのモラルチェックに-1DRM
- 横隊
  - 横隊の歩兵は射撃の戦闘ダイスに+1DRM
  - 横隊の馬は射撃の戦闘ダイスに-1DRM
  - 横隊の馬のいるヘクスを射撃するなら戦闘ダイスに-1DRM
  - 横隊の歩兵と馬は近接戦闘の戦闘ダイスに-1DRM
