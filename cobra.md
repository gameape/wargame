...
## トラックマーカー
- 連合軍機械化移動フェイズの移動完了後に補給下の合衆国歩兵師団に配置可
- 戦闘結果で退却したら配置されているトラックマーカーを除去、このマーカーは後に使用可
- 連合軍補充フェイズにトラックマーカーを別の補給下の合衆国歩兵師団に置き換え可
...
## 補充
- 敵ユニットから3ヘクス以上離れている補給下のユニットに1ステップ補充可
- ドイツ軍は1ターンに装甲/装甲擲弾兵1ステップと、歩兵2ステップまで
- 連合軍は数に制限なし

## 絨毯爆撃
- ゲーム中に一度だけ、連合軍戦闘フェイズの最初に実施
...
- ドイツ軍VP
	...
	- 3：第7ターンおよびより後のターン終了時ごとに、必要な合衆国師団またはその一部がマップを退出できていないごとに
	- 1：歩兵師団/歩兵連隊/HQのマップ退出ごとに
	- 3：装甲/装甲擲弾兵連隊/戦車大隊がマップ退出/ファレーズの東で補給下かつEZOCにいない or 第14ターンに離脱可能
- 連合軍VP
	- 1：歩兵師団/歩兵連隊/HQ/戦車大隊の除去ごとに
	- 3：装甲/装甲擲弾兵連隊の除去ごとに
	- 1：第7ターンにマップ退出した合衆国機甲連隊/旅団ごとに
	- 3：第7ターンにマップ退出した合衆国歩兵師団（トラックマーカーあり）ごとに
	- 2：第6ターンにマップ退出した合衆国機甲連隊/旅団ごとに
	- 6：第6ターンにマップ退出した合衆国歩兵師団（トラックマーカーあり）ごとに
	- 4：第5ターンにマップ退出した合衆国機甲連隊/旅団ごとに
	- 12：第5ターンにマップ退出した合衆国歩兵師団（トラックマーカーあり）ごとに
	- 6：第5ターンより前にマップ退出した合衆国機甲連隊/旅団ごとに
	- 18：第7ターンより前にマップ退出した合衆国歩兵師団（トラックマーカーあり）ごとに
...
- 3日/ターン、3.2㎞/ヘクス
- errata
  - https://grognard.com/errata/st/s&t65.txt
  - https://grognard.com/errata/st/s&t65x.txt
